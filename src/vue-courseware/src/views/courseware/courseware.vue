<template>
  <div class="main">
    <div class="btns">
      ...
      <el-button type="primary" @click="loadCarousel" plain
        >显示轮播图</el-button
      >
    </div>
    <el-table :data="tableData.list" style="width: 100%">
      ...
      <el-table-column label="封面" width="180">
        <template slot-scope="scope">
          <img
            class="cover"
            :src="getImgPath(scope.row.cover)"
      ...
      <el-table-column label="轮播封面" width="180">
        <template slot-scope="scope">
          <img
            class="cover"
            :src="getImgPath(scope.row.carouselUrl)"
            v-if="scope.row.carouselUrl"
          />
        </template>
      </el-table-column>
      ...
      <el-table-column label="下载地址" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column label="销售量" width="180">
        <template slot-scope="scope">
    ...
    <el-dialog title="添加课件" :visible.sync="show" width="50%" class="dialog">
      <el-form ref="form" :model="courseware" label-width="150px">
        ...
        <el-form-item label="价格" label-position="left">
          <el-input
            class="input price"
            placeholder="格式:12.99"
            v-model="courseware.price"
          ></el-input>
        </el-form-item>
        <el-divider></el-divider>
        <el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(index, row) {
      this.$http
        .get("/cwcourseware/delete", { params: { id: row.id } })
        .then((res) => {
